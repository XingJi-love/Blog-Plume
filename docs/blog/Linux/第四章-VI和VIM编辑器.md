...
tags:
  - Linux
createTime: 2026/05/25 23:34:40
permalink: /blog/ehrawqxo/
cover: ./Linux.jpg
---
![VI和VIM编辑器](./Linux.jpg)
...
![VI和VIM编辑器](./第四章-VI和VIM编辑器/img-1.jpg)
...
![](./image/image-20230703211138655.png)
...
![](./image/image-20230703205456739.png)
...
![](./image/image-20230703205250698.png)

* **模式间的切换**

![VI和VIM编辑器](./第四章-VI和VIM编辑器/img-2.jpg)

![](./image/image-20230703205329736.png)

> 如果非正常退出,如使用ctrl+z退出,再次编辑会提示交换文件". *.swp",文件存在,并给出相应的处理方式选项,如果不删除交换文件,每次编辑都会提示,这时可以删除交换文件,通过命令: rm -f .名称即可.swp 即可

```shell
rm -f .smartd.conf.swp
```
