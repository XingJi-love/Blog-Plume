...
tags:
    - RabbitMQ
createTime: 2026/05/15 00:57:27
permalink: /blog/o31n0s24/
cover: ./RabbitMQ.jpg
---
...
==<span style="color:blue;font-weight:bolder;">注意</span>：使用rabbitmq_delayed_message_exchange插件后，即使`消息成功发送到队列`上，也会`导致returnedMessage()方法执行`==
